...
const VideoPlayer = () => {
    ...
    return (
        <div className="w-full h-full bg-black relative overflow-hidden">
            ...
            {/* Video Content Area */}
            <div
                className="relative flex-1 h-full w-full cursor-pointer"
            ...
            {/* Bottom Controls */}
            <div
                className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6 transition-all duration-300 mb-4 ${showControls ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                    }`}
            >
                <div
