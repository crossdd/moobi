...
const About = () => {
  return (
    <section
      id="about"
      className="w-full relative flex flex-col lg:flex-row gap-8 min-h-screen"
    >
      <div className="flex justify-center flex-col px-4 md:px-12  md:justify-start lg:justify-center lg:basis-1/2">
        ...
        <div className="max-w-3xl text-[17px] md:text-xl mt-8 text-left leading-relaxed tracking-wide flex flex-col gap-3 text-gray-300">
          <p>
            I am Epiphanus Onyeso(a.k.a Unique). I am a fullstack developer engineer who enjoys building user-friendly applications that solve real-world problems and enhance user experiences.
          </p>
