...
const MagicButton = ({
  ...
  return (
    ...
    >
      ...
      <span
        className={`inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg px-7 text-sm backdrop-blur-3xl gap-2 text-gray-200 bg-violet-500/20`}
      >
        {position === "left" && icon}
        {title}
        {position === "right" && icon}
